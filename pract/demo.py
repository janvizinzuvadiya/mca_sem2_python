...
# 1). Accept subject name and marks from the user, store the data in the file. ii. Give three options to the user: a). To view whole file, b). Accept and edit the marks of a subject user want to
# change.
# iii). Exit
